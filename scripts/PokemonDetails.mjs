...
export async function fetchMovieDetails(movieId) {
    ...
    try {
        ...
        detailsContainer.innerHTML = `<p>Could not load movie details. Please try again later or go back <a href="index.html">home</a>.</p>`;
    }
...
export async function fetchMovieVideos(movieId) {
    ...
    try {
        ...
        videodeets.innerHTML = '<h2>Trailers</h2>';
